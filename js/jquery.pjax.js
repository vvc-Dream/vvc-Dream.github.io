...
(function ($) {
    var Util = {
        ...
        getLocalKey: function (src) {
            return 'pjax_' + encodeURIComponent(src);
        },
        // 清除所有的cache
        ...
        setCache: function (src, data, title, flag) {
            ...
            if (flag && Util.support.storage) {
                ...
                try {
                    ...
                    console.warn("Failed to execute 'setItem' on 'Storage': Setting the value of '" + key + "' exceeded the quota.");
                }
            }
        },
        // 清除cache
        removeCache: function (src) {
            try {
                ...
                delete Util.stack[src];
                if (Util.support.storage) {
                    localStorage.removeItem(Util.getLocalKey(src));
                }
            } catch (e) {
            }
        }
